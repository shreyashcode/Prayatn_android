package com.prayatnApp.theproductivityapp.receiver
...
import com.prayatnApp.theproductivityapp.ui.activityAndFragments.MainActivity
...
class ReminderReceiver: BroadcastReceiver() {
    ...
    private fun standupReminder(context: Context){
