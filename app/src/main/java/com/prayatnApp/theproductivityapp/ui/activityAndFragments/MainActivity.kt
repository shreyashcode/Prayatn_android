...
import com.prayatnApp.theproductivityapp.databinding.ActivityMainBinding
import com.prayatnApp.theproductivityapp.db.TodoDao
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = Navigation.findNavController(this, R.id.hosting)
