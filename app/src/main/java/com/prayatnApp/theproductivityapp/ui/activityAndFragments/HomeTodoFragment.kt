...
import com.prayatnApp.theproductivityapp.adapter.TagAdapter
...
import com.prayatnApp.theproductivityapp.databinding.FragmentHomeTodoBinding
...
class HomeTodoFragment : Fragment(R.layout.fragment_home_todo), ItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val observer = viewModel.reminders.observe(viewLifecycleOwner) {it->
            for (i in it) {
